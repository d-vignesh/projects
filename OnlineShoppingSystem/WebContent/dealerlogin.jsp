...
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
	...
	<head>
		...
		<link rel = "stylesheet" href = "stylingfile.css" type = "text/css" />
			...
			<script src ="javascript/dealerlogin.js"></script>
	</head>
	...
	<body>
		...
		<form id="dealerloginform" style = "margin-left : 15% ">
			
			<center> <div id="responsemsg" style = "color : red "></div> </center>
			<table style = "display : inline ">
				<tr> 
				<td> <h4 style = "color : green"> DealerLogin.. </h4></td>
				</tr>
				...
				<tr>
					<td>new user??</td>
					<td><a href = "dealersignup.jsp"> signup..</a></td>
					</tr>
			</table> 
